...
def make_predicate() -> Dict[str, Predicate]:
    ...
    return {
        ...
        "p_murder": Predicate("$person1 murdered $person2"),
        "p_murder_whether": Predicate("$person1 murdered $person2", truth=None),
        "p_murder_false": Predicate("$person1 murdered $person2", truth=False),
        ...
        "p_shooting": Predicate("$person1 shot $person2"),
        "p_shooting_self": Predicate("$person1 shot $person1"),
        "p_no_shooting": Predicate("$person1 shot $person2", truth=False),
        "p_shooting_whether": Predicate("$person1 shot $person2", truth=None),
        "p_no_crime": Predicate("$person1 committed a crime", truth=False),
        "p_three_entities": Predicate("$person1 told $person2 to hire $person3"),
...
def raw_factor() -> RawFactor:
    ...
    return {
        "relevant": {
            "content": "$evidence is relevant to show $fact",
            "type": "Fact",
            "name": "relevant fact",
            "context_factors": [
                {"content": "{Short Name} shot {Longer Name}", "type": "Fact"},
                {
                    "content": "$person1 murdered $person2",
