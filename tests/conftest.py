...
def watt_factor(make_predicate, make_entity, watt_mentioned) -> Dict[str, Factor]:
    ...
    return {
        ...
        "f1_entity_2": Fact(p["p1"], (2,), case_factors=c),
        ...
        "f4": Fact(p["p4"], case_factors=c),
        "f4_h4": Fact(p["p4"], (3, 0), case_factors=c),
        "f4_swap_entities": Fact(p["p4"], (1, 0), case_factors=c),
        "f4_swap_entities_4": Fact(p["p4"], (1, 4), case_factors=c),
        "f5": Fact(p["p5"], case_factors=c),
        "f5_h4": Fact(p["p5"], (3,), case_factors=c),
        "f5_swap_entities": Fact(p["p5"], (1,), case_factors=c),
        "f6": Fact(p["p6"], case_factors=c),
        "f6_swap_entities": Fact(p["p6"], (1,), case_factors=c),
        "f7": Fact(p["p7"], case_factors=c),
        "f7_swap_entities": Fact(p["p7"], (1, 0), case_factors=c),
        "f7_swap_entities_4": Fact(p["p7"], (1, 4), case_factors=c),
        "f7_true": Fact(p["p7_true"], case_factors=c),
        "f8": Fact(p["p8"], case_factors=c),
        "f8_absent": Fact(p["p8"], absent=True, case_factors=c),
        "f8_exact": Fact(p["p8_exact"], case_factors=c),
        "f8_exact_swap_entities": Fact(p["p8_exact"], (1, 0), case_factors=c),
        "f8_float": Fact(p["p8_float"], case_factors=c),
        "f8_higher_int": Fact(p["p8_higher_int"], case_factors=c),
        "f8_int": Fact(p["p8_int"], case_factors=c),
        "f8_less": Fact(p["p8_less"], case_factors=c),
        "f8_meters": Fact(p["p8_meters"], case_factors=c),
        "f9": Fact(p["p9"], case_factors=c),
        "f9_absent": Fact(p["p9"], absent=True, case_factors=c),
        "f9_absent_miles": Fact(p["p9_miles"], absent=True, case_factors=c),
        "f9_swap_entities": Fact(p["p9"], (1, 0), case_factors=c),
        "f9_swap_entities_4": Fact(p["p9"], (1, 4), case_factors=c),
        "f10": Fact(p["p10"], case_factors=c),
        ...
        "f10_swap_entities": Fact(p["p10"], (1, 0), case_factors=c),
